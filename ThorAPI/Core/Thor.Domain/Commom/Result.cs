...
public class Result
{
    ...
    public static Result Success(params string[] messages) => new Result { Succeeded = true, Messages = messages.ToList() };
    public static Result Success(List<string> messages) => new Result { Succeeded = true, Messages = messages };
...
public class Result<T> : Result
{
    ...
    public static Result<T> Fail(params string[] message) => new Result<T> { Succeeded = false, Messages = message.ToList() };
    public static Result<T> Fail(List<string> messages) => new Result<T> { Succeeded = false, Messages = messages };

    public static Result<T> Success(T data) => new Result<T> { Succeeded = true, Data = data };
    public static Result<T> Success(T data, params string[] messages) => new Result<T> { Succeeded = true, Data = data, Messages = messages.ToList() };
